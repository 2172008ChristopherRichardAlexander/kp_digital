<template>
  <b-container>
    ...
    <div class="form-konfirmasi-bimbingan">
      ...
      <div class="row">
        <div class="col">
          <h3 class="my-2">Daftar Mahasiswa Bimbingan MBKM</h3>
        </div>
      ...
      <div class="konfirmasi-bimbingan">
        ...
        >
          ...
          <template v-slot:cell(bimbingan)="data">
            <router-link
              :to="`/mbkm-bimbingan/Detail/${data.item.slug_topik}`"
              class="btn btn-form"
              >Lihat</router-link
            >
          </template>
...
export default {
  ...
  methods: {
    ...
    getBimbinganKonfirmasi() {
      ...
      this.loading = true;
      Axios.post(
        `${config.apiDosenUrl}/bimbingan-mbkm`,
        {
    ...
    getDaftarMahasiswa() {
      ...
      Axios.post(
        `${config.apiDosenUrl}/topik/mahasiswa-bimbingan-mbkm`,
        {
          id_batch: this.id_batch,
