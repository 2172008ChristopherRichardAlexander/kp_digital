<template>
  <b-container>
    ...
    <div class="permintaan">
      <div class="row">
        <div class="col">
          <h3 class="keterangan-website mt-2">Permintaan Persetujuan Sidang</h3>
        </div>
        <!-- // ? Pilih Batch -->
      ...
      <div class="form-persetujuan">
        ...
        <b-table
          ...
          hover
          striped
          :items="list_pembimbing"
          :fields="fields"
          @row-selected="onRowSelected"
          responsive="sm"
          :busy="isBusyPersetujuan"
          show-empty
        ...
        >
          ...
          <template v-slot:cell(bimbingan)="data">
            <router-link
              :to="`/sidang/bimbingan/${acakAcak(data.item.id_sidang, 0)}`"
              class="btn btn-form"
              >Lihat</router-link
            >
          </template>
          ...
          <b-col class="text-right">
            ...
            >
              <div class="btn-select">
                <b-button
                  class="btn-form"
                  @click="terimaPengajuanSidang(selected)"
                  >Terima</b-button
                >
                <b-button
                  class="btn-form"
                  @click="tolakPengajuanSidang(selected)"
                  >Tolak</b-button
                >
              </div>
            </template>
          ...
          <b-col class="text-right">
            ...
            >
              <div class="btn-select">
                <b-button
                  class="btn-form"
                  @click="terimaPengajuanSidang(selected_history)"
                  >Terima</b-button
                >
                <b-button
                  class="btn-form"
                  @click="tolakPengajuanSidang(selected_history)"
                  >Tolak</b-button
                >
              </div>
            </template>
