<template>
  <b-container>
    <div class="form-pembimbing-lapangan">
      ...
      <div class="row">
        <div class="col">
          <h3 class="keterangan-website my-2">Penilaian Pembimbing Lapangan</h3>
        </div>
      </div>
      ...
      <div class="pembimbing-lapangan" v-else>
          ...
          <div class="form-penilaian">
              ...
              <b-tbody>
                ...
                >
                  ...
                  <b-td class="table-penilaian-col col-nilai">
                    <div v-if="sidang.nilai_pembimbing_lapangan">
            ...
            <div class="btn-select text-right">
              <b-button
                class="btn-form"
                @click="periksaNilai"
                :disabled="sidang.nilai_pembimbing_lapangan"
                >Nilai</b-button
              >
              <!-- <b-button type="submit" class="btn-form">Nilai</b-button> -->
            </div>
          </div>
        </b-form>
  ...
  methods: {
    ...
    onSubmit() {
      ...
      if (this.submit_status === "BERHASIL") {
        ...
        const formData = new FormData();
        formData.append("id_sidang", this.sidang.id_sidang);
        formData.append("nilai_pembimbing_lapangan", this.nilai_total);
        Axios.post(
          `${config.apiDosenUrl}/sidang/penilaian-pembimbing-lapangan`,
          formData,
          {
            headers: {
              "Content-Type": "multipart/form-data",
      ...
      this.$router.push("/sidang/pembimbing-lapangan");
    },
    hitungNilaiTotal() {
